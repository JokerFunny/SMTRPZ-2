...
{
    class PoisonedStone : StoneDecorator
    {
        public PoisonedStone(int damage, Stone stone)
            : base(damage, stone.Description + ", will harm on every turn (ciborgs only)", stone.Weight, true, stone.StoneHealth, stone.Collapses, stone)
        {
